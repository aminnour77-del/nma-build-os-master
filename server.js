...
// PUNTO 2: Endpoint per generare il Report Tecnico As-Built (HTML stampabile in PDF)
...
// Torre di Controllo (Ufficio) con pulsante per scaricare il Report As-Built
...
app.listen(PORT, () => { console.log('✅ SERVER CON MODULO REPORT AS-BUILT ONLINE'); });
EOFcat << 'EOF' > server.js
const express = require('express');
const { Pool } = require('pg');
